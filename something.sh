...
### 扫描 swagger
cat urls.txt|httpx -H "User-Agent: ${UA}" -paths '/api/docs/,/swagger-resources,/v2/api-docs/,/api/swagger/index.yaml,/swagger/index.yaml' -title -status-code -content-length -content-type -follow-redirects -match-regex "\"swagger-ui\"|swaggerVersion|\"swagger\":|swagger:"
